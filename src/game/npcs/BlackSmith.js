...
class BlackSmith extends NPC 
{
    ...
    getDialog() {
        ...
        if(this.interactionPhase == 0) {
            ...
            this.dialogs.unshift("If you go north, when you get pass through a path, you may go either east or west. You will find limes in both directions")
            this.dialogs.unshift("But be careful, these limes are than the ones you might have found down there!")
            ...
            if(numBlobs == 0) {
                ...
                this.dialogs.unshift("If you are searching for limes, go north; when you get pass through a path, you may go either east or west. You will find limes in both directions")
                ...
                this.dialogs.unshift("Remember, you may find limes northeast or northwest");
            } else if(numBlobs >= 30) {
                ...
                this.dialogs.unshift("Now, go there and test your new sword with those limes!")
